				...
				<div class="row">
						...
						<div class="col-md-6 col-lg-4 col-xl-3">
								<div id="product-1" class="single-product">
										<div class="part-1" >
										<a href="viewProductImage?productId=<%=p.getProductId() %>">
										<img alt="" src="<%=p.getProductImagePath()%>">
										</a>	
												<ul>
														<li><a href="addtocart?productId=<%=p.getProductId() %>"><i class="fas fa-shopping-cart"></i></a></li>
														<li><a href="addtowishlist?productId=<%=p.getProductId()%>"><i class="fas fa-heart"></i></a></li>
